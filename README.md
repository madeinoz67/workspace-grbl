# com-chilipeppr-workspace-se-grbl
A ChiliPeppr Workspace grbl.



## ChiliPeppr SE Test Workspace / grbl
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-se-grbl |
| Name                  | SE Test Workspace / grbl |
| Description           | A ChiliPeppr Workspace grbl. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/madeinoz67/workspace-grbl/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/madeinoz67/se-grbl |
| Github URL            | http://github.com/madeinoz67/workspace-grbl |
| Test URL              | https://preview.c9users.io/madeinoz67/se-grbl/workspace.html |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-se-grbl"], // the id you gave your workspace
      function(myWorkspaceSeGrbl) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("SE Test Workspace / grbl just got loaded.", myWorkspaceSeGrbl);
        myWorkspaceSeGrbl.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-se-grbl"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"SE Test Workspace / grbl"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace grbl."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/madeinoz67/workspace-grbl/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/madeinoz67/se-grbl"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/madeinoz67/workspace-grbl"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://se-grbl-madeinoz67.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
